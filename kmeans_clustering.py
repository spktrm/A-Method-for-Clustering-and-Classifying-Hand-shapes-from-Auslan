...
if not os.path.exists(file + "/kmeans_right_hand_clusters"):
    os.mkdir(file + "/kmeans_right_hand_clusters")
...
with alive_bar(len(df)) as bar:
    ...
    for i in range(n_Kmeans):
        cluster_folder_path = file + "/kmeans_right_hand_clusters/" + str(i)
...
if not os.path.exists(file + "/kmeans_left_hand_clusters"):
    os.mkdir(file + "/kmeans_left_hand_clusters")
...
with alive_bar(len(df)) as bar:
    ...
    for i in range(n_Kmeans):
        cluster_folder_path = file + "/kmeans_left_hand_clusters/" + str(i)
